...
export default class BlackjackScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.infoText = this.add.text(width / 2, 60, `Ma ${this.mans + 1}/${this.maxMans}`, {
        ...
        this.add.text(selX, selY - 80, 'APOSTA', {
    ...
    confirmarAposta() {
        ...
        this.btnPedirCarta.setVisible(true).setInteractive({ useHandCursor: true })
        this.btnPlantar.setVisible(true).setInteractive({ useHandCursor: true })
        this.repartirMa()
    }
    ...
    repartirMa() {
        ...
        this.infoText.setText(`Ma ${this.mans + 1}/${this.maxMans}`)
        this.btnPedirCarta.setVisible(true).setInteractive({ useHandCursor: true })
        this.btnPlantar.setVisible(true).setInteractive({ useHandCursor: true })
